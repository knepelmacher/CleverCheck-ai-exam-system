    ...
    <Box>
      ...
      >
        ...
        <Container maxWidth="md" sx={{ position: 'relative', zIndex: 1 }}>
          <Typography variant="h2" fontWeight={800} mb={2} sx={{ fontSize: { xs: '2.5rem', md: '3.75rem' } }}>
            Gradex
          </Typography>
          <Typography variant="h5" mb={4} sx={{ opacity: 0.9, fontWeight: 400, fontSize: { xs: '1.1rem', md: '1.5rem' } }}>
